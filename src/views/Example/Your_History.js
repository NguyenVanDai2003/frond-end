...
function Your_History() {
    ...
    useEffect(() => {
        ...
        // let arr_pri = []
        instance.get(`history/your_his/his/${infor.email}`)
            .then(res => {
                console.log("res", res)
                const number_tk = res.data;
                setPrize(number_tk);
                console.log("number", number_tk)
            })
                        ...
                        <div className=" yourHistory">
                            ...
                            <div>
                                <table border={1}>
                                    ...
                                    <tbody>
                                        {
                                            prize.map(function (element) {
                                                return (
                                                    <tr>
                                                        <td>{element.buy_number}</td>
                                                        <td>Match first: {element.HistoryEntity_Lottery_prizes}</td>
                                                    </tr>
                                                )
                                            })

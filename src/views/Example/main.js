                ...
                <div className="main4 py-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div className="btn-his">
                                    <NavLink to="/all_History">All History</NavLink>

                                    <NavLink to="/your_history">Your History</NavLink>
                                </div>
                            </div>
                            <div className="col-md-4 ">
                    ...
                    <div className="box">
                        <div className=" main5">
                            ...
                            <hr></hr>
                            <div className="row">
                                <div className="col-md-3 col-sm-5 under">
                                    <h4>Winning Number</h4>
                                </div>

                                <div className="col-md-9 col-sm-7 num0">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <div className="col-md-6 ">
                                <img src={require('../../assets/images/tombola.png')} alt="Image" />
                            </div>
                            <div className="col-md-6">
